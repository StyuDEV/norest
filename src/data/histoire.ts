...
export type VersionId = "longue" | "courte";
...
const courte: Version = {
  ...
  short: "Courte",
  paragraphs: [
    "William et Léonidas se rencontrent en 2013. Ils ont seize ans. Ils grandissent ensemble dans le même décor : Paris Est. À cet âge où l'on cherche encore qui l'on veut devenir, eux cherchent déjà ce qu'ils vont construire ensemble.",
    "Caméras en main, leurs quartiers deviennent leurs terrains d'apprentissage, ils parlent le même langage. Pas seulement celui de l'image, celui de l'obsession. Créer, comprendre, explorer, toujours plus loin.",
    "Puis il y avait ce petit kebab de quartier, abordable et sincère. Avec le temps, l'endroit devient une seconde maison. Le patron travaille avec son père, un homme âgé, discret, fatigué parfois, mais toujours debout. Des produits frais, des journées sans repos. Une certaine idée de la dignité. Ils regardent ça sans forcément se le dire, mais ils apprennent déjà. Le travail, la loyauté, la transmission et surtout : construire quelque chose de vrai.",
    "Cette idée finit par prendre un nom : \"Slice\". Comme la part qu'on partage autour d'une table ou comme l'outil de montage. Résumant parfaitement leur histoire : tout partager. Le temps, les idées, les galères, les projets. Mais le nom existe déjà ailleurs. Alors ils cherchent encore, longtemps. Jusqu'à trouver celui qui avait toujours été là.",
    "D'un côté, il y a les terres des ancêtres de William, le Nord-Est du Brésil. De l'autre, celles de Léonidas : l'Alsace, elle aussi au Nord-Est. Deux héritages différents, une même direction, pour ce binôme du Nord-Est parisien.",
    "Nord-Est / No Rest / \"NOREST\".",
    "Aujourd'hui, ils ont trente ans, et pour la première fois, ils prennent le temps. Pas pour ralentir, mais pour donner une forme définitive à tout ce qu'ils ont construit. C'est l'histoire de deux garçons devenus des hommes sans jamais abandonner la version adolescente d'eux-mêmes. Celle qui croyait encore que l'amitié pouvait durer quinze ans. Que les rêves pouvaient survivre aux factures. Que créer avait plus de valeur que paraître.",
    "Et qu'au milieu du bruit, des nuits blanches et des villes qui changent… certaines promesses, elles, ne disparaissent jamais.",
    "NOREST.",
  ],
};
...
export const versionOrder: VersionId[] = ["longue", "courte"];
